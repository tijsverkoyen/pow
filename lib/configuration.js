...
(function() {
  ...
  module.exports = Configuration = (function() {
    ...
    Configuration.prototype.initialize = function(env1) {
      ...
      this.env = env1;
      this.bin = (ref = env.POW_BIN) != null ? ref : path.join(__dirname, "../bin/pow");
      this.dstPort = (ref1 = env.POW_DST_PORT) != null ? ref1 : 80;
      this.httpPort = (ref2 = env.POW_HTTP_PORT) != null ? ref2 : 20559;
      this.dnsPort = (ref3 = env.POW_DNS_PORT) != null ? ref3 : 20560;
      this.timeout = (ref4 = env.POW_TIMEOUT) != null ? ref4 : 15 * 60;
      this.workers = (ref5 = env.POW_WORKERS) != null ? ref5 : 2;
      this.domains = (ref6 = (ref7 = env.POW_DOMAINS) != null ? ref7 : env.POW_DOMAIN) != null ? ref6 : "dev";
      this.extDomains = (ref8 = env.POW_EXT_DOMAINS) != null ? ref8 : [];
      ...
      this.hostRoot = (ref11 = env.POW_HOST_ROOT) != null ? ref11 : path.join(this.supportRoot, "Hosts");
      this.logRoot = (ref12 = env.POW_LOG_ROOT) != null ? ref12 : libraryPath("Logs", "Pow");
      this.rvmPath = (ref13 = env.POW_RVM_PATH) != null ? ref13 : path.join(process.env.HOME, ".rvm/scripts/rvm");
